...
public class guiDeposito extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Seleccione la cuenta para el depósito");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Cuenta 1", "Cuenta 2", "Cuenta 3", "Cuenta 4" }));

        jButton1.setText("Aceptar");//boton

        jLabel4.setText("Monto");//etiqueta


        jLabel2.setText("Pin");

        String montoStr =  jTextField1.getText();//campo de texto
