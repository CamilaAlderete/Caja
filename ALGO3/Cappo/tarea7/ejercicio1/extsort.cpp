...
const int MaxString = 128; /* Ajustado por CCA, originalmente 32 */
...
/*
   Ajustado por CCA. 
      _itoa : usualmente solo para plataformas Windows.

void _itoa( int k, char * Buff, int prec) {
    sprintf(Buff, "%d", k);
}
*/
