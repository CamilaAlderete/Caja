/*
	...
	!Falta implementar la clase sleep
   ...
   public static void main(String [] argv) {
    ...
    for (int j=0 ; j<1000000 ; j++) {
     ...
     int elOrden;
	   ...
	   System.out.println("Inserte un numero entero positivo para el orden del arbol con 13 elementos");
	   ...
	   while(opcion <=2 ){
        ...
        /*--------------------------------------------------------------------------------*/
				...
				System.out.println("B-Arbol grado 1000");
					b_Arbol = new BArbol1<Integer>(1000);
        ...
        for (int j=0; j<A.size(); j++){
          b_Arbol.agregar(A.get(j));
				...
				System.out.println("Insercion:"+t_barb_ins+"\nBusqueda:"+t_barb_bus);
