...
class problema1{
	...
	/*void imprimir(ArrayList<ArrayList<Integer>> lista,ArrayList<String> vertices){
	...
	void procesarDatos(ArrayList<String> cadena){
		...
		while(i.hasNext()){
			...
			if ( cadena1.charAt(0) != cadena2.charAt(0) ) { 
				//System.out.println(cadena1.charAt(0)+" menor que "+cadena2.charAt(0));
